...
public class Main {
  public static void main(String[] args) {
    se.metricspace.lotto.Statistics statistics = se.metricspace.lotto.ForkJoined.execute(2, new Competition(), new Generator(6,new java.util.Random(System.currentTimeMillis())));
